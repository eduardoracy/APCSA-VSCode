...
public class JeopardyBoard {
    ...
    public JeopardyBoard(JeopardyPlayer player1, JeopardyPlayer player2, JeopardyBoardCategory category1, JeopardyBoardCategory category2,
    ...
    public String printBoardCellSpacing(String str, int numberOfWords) {
        for(int i = 0; i < numberOfWords; i ++) {
        Utilities.textCenter(str, ' ', 12);
        }
    }

    public int detectNumberOfWords(String str, int index) {
        if (index >= str.length()) {
            return 0;
        } else {
            int count = 0;
            ...
            return count + detectNumberOfWords(str, index + 1);
        }
    }
